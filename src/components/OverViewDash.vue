<template>
  <Transition>
    <div class="overview-dash-container" v-if="isLoaded">
      <div class="overview-dash-heading">
        <h3 class="overview-dash-heading-title">Total Balance</h3>
        <h1 class="balance">{{ formatCurrency(balance) }}</h1>
      </div>
      <span class="overview-hr"></span>
      <div class="last-budgets">
        ...
        <div class="last-budgets-cards" v-if="hasBudgets">
          <div class="last-budgets-headings">
            <h1>Recent Budgets</h1>
            <router-link to="/overview/budget">See All</router-link>
          </div>
          <div
            class="last-budgets-card"
            v-for="budget in lastFourBudgets()"
            :key="budget.budgetid"
          >
...
.overview-dash-container .overview-dash-heading {
  display: flex;
  flex-direction: column;
...
.overview-dash-container .overview-dash-heading .overview-dash-heading-title {
  font-size: 1.4rem;
  color: #a2a2a2;
  font-weight: 100;
}
.overview-dash-container .overview-dash-heading .balance {
  font-size: 2rem;
  font-weight: normal;
  color: $text-color;
}
...
.overview-dash-container .last-budgets {
  display: flex;
  justify-content: center;
  align-items: center;
  width: 100%;
...
.overview-dash-container .last-budgets .last-budgets-cards .last-budgets-card {
  width: 100%;
  display: flex;
  justify-content: space-between;
  align-items: center;
